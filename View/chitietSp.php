        ...
        <div class="content-ctsp">
            ...
            <div class="ctsp-right">
                <div class="ctsp-right-price mb">  
                    <p class="price-new">31.500.000 VNĐ</p>
                    <p class="price-old"><del>35.000.000 VNĐ</del></p>
                </div>
                ...
                <div class="ctsp-khuyenmai mb">
                    ...
                    <div class="ctsp-box-khuyenmai">
                        <div class="ctsp-ttkm"><div class="ctsp-sttkm">1</div>Nhập mã MMSALE100 giảm ngay 1% tối đa 100.000đ khi thanh toán qua MOMO</div>
                        <div class="ctsp-ttkm"><div class="ctsp-sttkm">2</div>Hoàn 200,000đ cho chủ thẻ tín dụng HOME CREDIT khi thanh toán đơn hàng từ 5,000,000đ</div>
                        <div class="ctsp-ttkm"><div class="ctsp-sttkm">3</div>Nhập mã VNPAYTAO giảm ngay 200K cho đơn hàng từ 15 Triệu, chỉ áp dụng thanh toán VNPAY-QR tại cửa hàng</div>
                        <div class="ctsp-ttkm"><div class="ctsp-sttkm">4</div>Nhập mã ZLPIP15 giảm ngay 300K cho đơn hàng từ 20 Triệu, chỉ áp dụng thanh toán qua Ví ZALOPAY tại cửa hàng</div>
                    </div>
                </div>
                <div class="ctsp-box-button">
                <a href="#" class="ctsp-button-left">
                    <h3>MUA NGAY</h3>
                    <p>Giao hàng miễn phí cho lần đầu</p>
                </a>
                <a href="index.php?act=cart" class="ctsp-button-right">
                    <h4>Thêm giỏ hàng</h4>
