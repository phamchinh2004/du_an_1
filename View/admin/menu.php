        ...
        <div class="aside_menu">
            <ul class="aside_menu_list">
                <li class="aside_menu_list_item">
                    <a class="aside_menu_list_item_link" href="index.php?act=trangchu">Trang chủ</a>
                </li>
                <li class="aside_menu_list_item" tabindex="0">
                    ...
                    <ul class="aside_menu_list_item_hidden">
                        <li class="aside_menu_list_item_hidden_item">
                            <a class="aside_menu_list_item_hidden_item_link" href="index.php?act=listsp">- Quản lý sản phẩm</a>
                        </li>
                        <li class="aside_menu_list_item_hidden_item">
                ...
                <li class="aside_menu_list_item">
                    <a class="aside_menu_list_item_link" href="index.php?act=listvote">Đánh giá</a>
                </li>
                <li class="aside_menu_list_item">
