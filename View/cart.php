        ...
        <div style="width: 100%;">
            <table class="mb box-cart">
                ...
                <?php if (!empty($listSpCart)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="index.php?act=updateQuantity" method="POST">
                                    <input type="text" hidden name="idsp" value="<?= $idsp ?>">
                            ...
                            <td>
                                <a href="index.php?act=formthanhtoan&idsp=<?= $idsp ?>">
                                    <input style="margin-bottom:10px;" type="button" value="Đặt hàng">
                                </a>
                                <a href="index.php?act=deleteSpCart&idsp=<?= $idsp ?>">
                                <input onclick="return confirm('Bạn có chắc chắn muốn xóa khỏi giỏ hàng?')" type="button" value="Xoá">
                                </a>
                            </td>
                        </tr>
                    <?php }
                    ...
                    <tr>
                        <td colspan="7" class="addCart" style="text-align:center;"><a style="text-decoration:none;color:#fff;font-size:18px;" href="index.php?act=trangchu">Thêm ngay</a></td>
                    </tr>
                <?php } ?>
                <tr>
                    <td>&nbsp;</td>
